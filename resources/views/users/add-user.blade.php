            ...
            <div class="card-body">
                <form action="{{ route('user.add') }}" method="POST">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="text" name="name" value="" id="example-text-input" placeholder="Nama User">
                        </div>
                        <br><br>
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="text" name="email" value="" id="example-text-input" placeholder="email">
                        </div>
                        <br><br>
